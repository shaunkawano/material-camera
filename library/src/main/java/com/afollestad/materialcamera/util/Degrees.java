...
public class Degrees {
  ...
  }) @Retention(RetentionPolicy.SOURCE) @interface ActivityOrientation {
  }

  @IntDef({ DEGREES_0, DEGREES_90, DEGREES_180, DEGREES_270, DEGREES_360 })
  @Retention(RetentionPolicy.SOURCE) public @interface DegreeUnits {
  }
  ...
  @DegreeUnits public static int mirror(@DegreeUnits int orientation) {
    switch (orientation) {
      case DEGREES_0:
      case DEGREES_360:
        return DEGREES_180;
  ...
  @DegreeUnits public static int getDisplayRotation(Context context) {
  ...
  @ActivityOrientation public static int getActivityOrientation(@NonNull Activity context) {
