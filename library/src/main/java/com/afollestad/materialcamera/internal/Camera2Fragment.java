 ...
 */
@TargetApi(Build.VERSION_CODES.LOLLIPOP) public class Camera2Fragment extends BaseCameraFragment
  ...
  @Override public void openCamera() {
    ...
    try {
      ...
      @Degrees.DegreeUnits final int sensorOrientation =
      ...
      if (mInterface.useStillshot()) {
        ...
        mVideoSize = chooseVideoSize((BaseCaptureInterface) activity,
  ...
  @Override public void onPreferencesUpdated() {
    if (mInterface == null || !mInterface.useStillshot() || mPreviewSession == null
      ...
      mMediaRecorder.setOnInfoListener(new MediaRecorder.OnInfoListener() {
        @Override public void onInfo(MediaRecorder mediaRecorder, int what, int extra) {
          if (what == MediaRecorder.MEDIA_RECORDER_INFO_MAX_FILESIZE_REACHED) {
            Toast.makeText(getActivity(), R.string.mcam_file_size_limit_reached, Toast.LENGTH_SHORT)
                .show();
  ...
  @Override public void stopRecordingVideo(boolean reachedZero) {
