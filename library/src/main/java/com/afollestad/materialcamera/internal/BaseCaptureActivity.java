...
public abstract class BaseCaptureActivity extends AppCompatActivity
  ...
  @Retention(RetentionPolicy.SOURCE) public @interface CameraPosition {
  }
  ...
  @Override protected final void onSaveInstanceState(Bundle outState) {
  ...
  @Override protected final void onCreate(Bundle savedInstanceState) {
    ...
    if (!CameraUtil.hasCamera(this)) {
      new MaterialDialog.Builder(this).title(R.string.mcam_error)
  ...
  @NonNull public abstract Fragment getFragment();
  ...
  @Override public void setRecordingStart(long start) {
  ...
  @Override public long getRecordingStart() {
    return mRecordingStart;
  }

  @Override public void setRecordingEnd(long end) {
    mRecordingEnd = end;
  }

  @Override public long getRecordingEnd() {
    return mRecordingEnd;
  }

  @Override public long getLengthLimit() {
    return mLengthLimit;
  }

  @Override public boolean hasLengthLimit() {
    return getLengthLimit() > -1;
  }

  @Override public boolean countdownImmediately() {
    return getIntent().getBooleanExtra(CameraIntentKey.COUNTDOWN_IMMEDIATELY, false);
  }

  @Override public void setCameraPosition(int position) {
    mCameraPosition = position;
  }

  @Override public void toggleCameraPosition() {
  ...
  @Override public int getCurrentCameraPosition() {
    return mCameraPosition;
  }

  @Override public Object getCurrentCameraId() {
    if (getCurrentCameraPosition() == CAMERA_POSITION_FRONT) {
  ...
  @Override public void setFrontCamera(Object id) {
    mFrontCameraId = id;
  }

  @Override public Object getFrontCamera() {
    return mFrontCameraId;
  }

  @Override public void setBackCamera(Object id) {
    mBackCameraId = id;
  }

  @Override public Object getBackCamera() {
  ...
  @Override public final void onRetry(@Nullable String outputUri) {
  ...
  @Override public void onShowStillshot(String outputUri) {
    if (shouldAutoSubmit()) {
      useMedia(outputUri);
    } else {
  ...
  @Override public final boolean allowRetry() {
    return getIntent().getBooleanExtra(CameraIntentKey.ALLOW_RETRY, true);
  }

  @Override public final boolean shouldAutoSubmit() {
  ...
  public final void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
    ...
    if (grantResults[0] == PackageManager.PERMISSION_DENIED) {
      new MaterialDialog.Builder(this).title(R.string.mcam_permissions_needed)
