...
public class VideoStreamView extends SurfaceView
  ...
  public void setURI(@NonNull Activity context, @NonNull Uri uri, @NonNull Callback callback) {
    ...
    try {
      ...
      e.printStackTrace();
      new MaterialDialog.Builder(mContext).title(R.string.mcam_error)
  ...
  }) @Retention(RetentionPolicy.SOURCE) public @interface ActivityOrientation {
  }

  @ActivityOrientation public static int getScreenOrientation(Activity context) {
